  ...
  return (
    <>
      ...
      <section className="card p-5 mb-4">
        ...
        {mode === 'none' && (!pinEnabled ? <button onClick={() => setMode('pin-set')} className="btn-primary text-sm">Thiết lập PIN</button> : <button onClick={() => setMode('pin-change')} className="btn-secondary text-sm">Đổi PIN</button>)}
